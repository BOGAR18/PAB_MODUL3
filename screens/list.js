...
import { FlatList, Image, Text, TouchableOpacity, View, Modal, Button, StyleSheet, } from "react-native";
  ...
  // Dummmy Data (Array of Object)
   ...
   const List = () => {
    ...
    const renderItem = ({ item }) => {
      return (
        <TouchableOpacity style={styles.view} onPress={() => open(item)}>
          <View>
    ...
    return (
      <View>
        ...
        visible={modalVisible} animationType="fade">
          ...
          <View style={{backgroundColor:"#fffffff", margin:50,padding:40,borderRadius:10,flex:1}}>
